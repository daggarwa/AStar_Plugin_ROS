...
if("FALSE" STREQUAL "TRUE")
  set(rosnode_SOURCE_PREFIX /home/turtlebot/turtlebot_plugin_ws/src/ros_comm/tools/rosnode)
  set(rosnode_DEVEL_PREFIX /home/turtlebot/turtlebot_plugin_ws/devel)
  set(rosnode_INSTALL_PREFIX "")
  set(rosnode_PREFIX ${rosnode_DEVEL_PREFIX})
else()
  set(rosnode_SOURCE_PREFIX "")
  set(rosnode_DEVEL_PREFIX "")
  set(rosnode_INSTALL_PREFIX /home/turtlebot/turtlebot_plugin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/turtlebot_plugin_ws/install/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosnode_dep}_FOUND)
      find_package(${rosnode_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosnode_dep} REQUIRED ${depend_list})
  endif()
