...
if("FALSE" STREQUAL "TRUE")
  set(rostopic_SOURCE_PREFIX /home/turtlebot/turtlebot_plugin_ws/src/ros_comm/tools/rostopic)
  set(rostopic_DEVEL_PREFIX /home/turtlebot/turtlebot_plugin_ws/devel)
  set(rostopic_INSTALL_PREFIX "")
  set(rostopic_PREFIX ${rostopic_DEVEL_PREFIX})
else()
  set(rostopic_SOURCE_PREFIX "")
  set(rostopic_DEVEL_PREFIX "")
  set(rostopic_INSTALL_PREFIX /home/turtlebot/turtlebot_plugin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rostopic' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rostopic' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/turtlebot_plugin_ws/install/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rostopic_dep}_FOUND)
      find_package(${rostopic_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rostopic_dep} REQUIRED ${depend_list})
  endif()
