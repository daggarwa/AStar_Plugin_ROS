...
echo_and_run cd "/home/turtlebot/turtlebot_plugin_ws/src/ros_comm/tools/rostest"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/turtlebot/turtlebot_plugin_ws/build/ros_comm/tools/rostest" \
    install \
    $DESTDIR_ARG \
