...
"""autogenerated by genpy from test_roslib_comm/FieldNameChange1.msg. Do not edit."""
import sys
...
class FieldNameChange1(genpy.Message):
  _md5sum = "31a9992534c4d020bfc4045e7dc1a786"
  _type = "test_roslib_comm/FieldNameChange1"
...
float64[] e"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FieldNameChange1, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.a is None:
        self.a = test_roslib_comm.msg.SameSubMsg1()
    else:
      self.a = test_roslib_comm.msg.SameSubMsg1()
