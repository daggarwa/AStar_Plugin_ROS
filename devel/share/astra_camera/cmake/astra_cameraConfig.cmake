...
if("TRUE" STREQUAL "TRUE")
  set(astra_camera_SOURCE_PREFIX /home/turtlebot/turtlebot_plugin_ws/src/ros_astra_camera)
  set(astra_camera_DEVEL_PREFIX /home/turtlebot/turtlebot_plugin_ws/devel)
  ...
  set(astra_camera_INSTALL_PREFIX /home/turtlebot/turtlebot_plugin_ws/install)
...
if(NOT "/home/turtlebot/turtlebot_plugin_ws/devel/include;/home/turtlebot/turtlebot_plugin_ws/src/ros_astra_camera/include " STREQUAL " ")
  set(astra_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/turtlebot/turtlebot_plugin_ws/devel/include;/home/turtlebot/turtlebot_plugin_ws/src/ros_astra_camera/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'astra_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Tim Liu <liuhua@orbbec.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'astra_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/turtlebot_plugin_ws/src/ros_astra_camera/${idir}'.  Ask the maintainer 'Tim Liu <liuhua@orbbec.com>' to fix it.")
    endif()
...
set(astra_camera_EXPORTED_TARGETS "astra_camera_gencfg;astra_camera_generate_messages_cpp;astra_camera_generate_messages_lisp;astra_camera_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${astra_camera_dep}_FOUND)
      find_package(${astra_camera_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${astra_camera_dep} REQUIRED ${depend_list})
  endif()
