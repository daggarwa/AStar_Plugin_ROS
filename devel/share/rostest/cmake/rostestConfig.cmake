...
if("TRUE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /home/turtlebot/turtlebot_plugin_ws/src/ros_comm/tools/rostest)
  set(rostest_DEVEL_PREFIX /home/turtlebot/turtlebot_plugin_ws/devel)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX /home/turtlebot/turtlebot_plugin_ws/install)
...
if(NOT "/home/turtlebot/turtlebot_plugin_ws/src/ros_comm/tools/rostest/include;/usr/include " STREQUAL " ")
  set(rostest_INCLUDE_DIRS "")
  set(_include_dirs "/home/turtlebot/turtlebot_plugin_ws/src/ros_comm/tools/rostest/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/turtlebot_plugin_ws/src/ros_comm/tools/rostest/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rostest_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rostest_dep}_FOUND)
      find_package(${rostest_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rostest_dep} REQUIRED ${depend_list})
  endif()
