...
(cl:defclass <ArrayVal> (roslisp-msg-protocol:ros-message)
  ((vals
    :reader vals
    :initarg :vals
    :type (cl:vector test_rostopic-msg:Val)
   :initform (cl:make-array 0 :element-type 'test_rostopic-msg:Val :initial-element (cl:make-instance 'test_rostopic-msg:Val))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArrayVal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArrayVal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_rostopic-msg:<ArrayVal> is deprecated: use test_rostopic-msg:ArrayVal instead.")))

(cl:ensure-generic-function 'vals-val :lambda-list '(m))
(cl:defmethod vals-val ((m <ArrayVal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:vals-val is deprecated.  Use test_rostopic-msg:vals instead.")
  (vals m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArrayVal>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'vals)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'test_rostopic-msg:Val))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArrayVal>)))
  ...
  (cl:format cl:nil "Val[] vals~%================================================================================~%MSG: test_rostopic/Val~%string val~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArrayVal)))
  "Returns full string definition for message of type 'ArrayVal"
  (cl:format cl:nil "Val[] vals~%================================================================================~%MSG: test_rostopic/Val~%string val~%~%"))
