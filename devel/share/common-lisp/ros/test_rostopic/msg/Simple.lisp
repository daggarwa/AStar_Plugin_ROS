...
(cl:defmethod cl:initialize-instance :after ((m <Simple>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Simple)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_rostopic-msg:<Simple> is deprecated: use test_rostopic-msg:Simple instead.")))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:b-val is deprecated.  Use test_rostopic-msg:b instead.")
  (b m))

(cl:ensure-generic-function 'int16-val :lambda-list '(m))
(cl:defmethod int16-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:int16-val is deprecated.  Use test_rostopic-msg:int16 instead.")
  (int16 m))

(cl:ensure-generic-function 'int32-val :lambda-list '(m))
(cl:defmethod int32-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:int32-val is deprecated.  Use test_rostopic-msg:int32 instead.")
  (int32 m))

(cl:ensure-generic-function 'int64-val :lambda-list '(m))
(cl:defmethod int64-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:int64-val is deprecated.  Use test_rostopic-msg:int64 instead.")
  (int64 m))

(cl:ensure-generic-function 'c-val :lambda-list '(m))
(cl:defmethod c-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:c-val is deprecated.  Use test_rostopic-msg:c instead.")
  (c m))

(cl:ensure-generic-function 'uint16-val :lambda-list '(m))
(cl:defmethod uint16-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:uint16-val is deprecated.  Use test_rostopic-msg:uint16 instead.")
  (uint16 m))

(cl:ensure-generic-function 'uint32-val :lambda-list '(m))
(cl:defmethod uint32-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:uint32-val is deprecated.  Use test_rostopic-msg:uint32 instead.")
  (uint32 m))

(cl:ensure-generic-function 'uint64-val :lambda-list '(m))
(cl:defmethod uint64-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:uint64-val is deprecated.  Use test_rostopic-msg:uint64 instead.")
  (uint64 m))

(cl:ensure-generic-function 'str-val :lambda-list '(m))
(cl:defmethod str-val ((m <Simple>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:str-val is deprecated.  Use test_rostopic-msg:str instead.")
  (str m))
