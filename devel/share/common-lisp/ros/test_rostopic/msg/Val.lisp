...
(cl:defmethod cl:initialize-instance :after ((m <Val>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Val)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_rostopic-msg:<Val> is deprecated: use test_rostopic-msg:Val instead.")))

(cl:ensure-generic-function 'val-val :lambda-list '(m))
(cl:defmethod val-val ((m <Val>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rostopic-msg:val-val is deprecated.  Use test_rostopic-msg:val instead.")
  (val m))
