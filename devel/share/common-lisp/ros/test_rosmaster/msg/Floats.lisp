...
(cl:defmethod cl:initialize-instance :after ((m <Floats>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_rosmaster-msg:<Floats> is deprecated: use test_rosmaster-msg:Floats instead.")))
