...
(cl:defmethod cl:initialize-instance :after ((m <TVals>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TVals)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_rosmaster-msg:<TVals> is deprecated: use test_rosmaster-msg:TVals instead.")))
