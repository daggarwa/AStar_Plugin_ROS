...
(cl:defclass <Embed> (roslisp-msg-protocol:ros-message)
  ((simple
    :reader simple
    :initarg :simple
    :type test_rosmaster-msg:Simple
    :initform (cl:make-instance 'test_rosmaster-msg:Simple))
   (arrays
    :reader arrays
    :initarg :arrays
    :type test_rosmaster-msg:Arrays
    :initform (cl:make-instance 'test_rosmaster-msg:Arrays)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Embed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Embed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_rosmaster-msg:<Embed> is deprecated: use test_rosmaster-msg:Embed instead.")))

(cl:ensure-generic-function 'simple-val :lambda-list '(m))
(cl:defmethod simple-val ((m <Embed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rosmaster-msg:simple-val is deprecated.  Use test_rosmaster-msg:simple instead.")
  (simple m))

(cl:ensure-generic-function 'arrays-val :lambda-list '(m))
(cl:defmethod arrays-val ((m <Embed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_rosmaster-msg:arrays-val is deprecated.  Use test_rosmaster-msg:arrays instead.")
  (arrays m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Embed>)))
  ...
  (cl:format cl:nil "#for rostopic tests~%Simple simple~%Arrays arrays~%~%================================================================================~%MSG: test_rosmaster/Simple~%# for rostopic tests~%byte b~%int16 int16~%int32 int32~%int64 int64~%char c~%uint16 uint16~%uint32 uint32~%uint64 uint64~%string str~%~%================================================================================~%MSG: test_rosmaster/Arrays~%#for rostopic tests~%int8[] int8_arr~%uint8[] uint8_arr~%int32[] int32_arr~%uint32[] uint32_arr~%string[] string_arr~%time[] time_arr~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Embed)))
  "Returns full string definition for message of type 'Embed"
  (cl:format cl:nil "#for rostopic tests~%Simple simple~%Arrays arrays~%~%================================================================================~%MSG: test_rosmaster/Simple~%# for rostopic tests~%byte b~%int16 int16~%int32 int32~%int64 int64~%char c~%uint16 uint16~%uint32 uint32~%uint64 uint64~%string str~%~%================================================================================~%MSG: test_rosmaster/Arrays~%#for rostopic tests~%int8[] int8_arr~%uint8[] uint8_arr~%int32[] int32_arr~%uint32[] uint32_arr~%string[] string_arr~%time[] time_arr~%~%~%"))
