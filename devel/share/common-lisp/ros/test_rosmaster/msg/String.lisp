...
(cl:defmethod cl:initialize-instance :after ((m <String>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_rosmaster-msg:<String> is deprecated: use test_rosmaster-msg:String instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<String>)))
  ...
  (cl:format cl:nil "# Copy of std_msgs/String.msg to avoid having tests require a dependency on std_msgs.~%string data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'String)))
  "Returns full string definition for message of type 'String"
  (cl:format cl:nil "# Copy of std_msgs/String.msg to avoid having tests require a dependency on std_msgs.~%string data~%~%~%"))
