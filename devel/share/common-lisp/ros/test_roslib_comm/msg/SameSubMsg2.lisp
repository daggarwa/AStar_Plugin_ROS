...
(cl:defclass <SameSubMsg2> (roslisp-msg-protocol:ros-message)
  ((a
    :reader a
    :initarg :a
    :type cl:integer
...
(cl:defclass SameSubMsg2 (<SameSubMsg2>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SameSubMsg2>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SameSubMsg2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_roslib_comm-msg:<SameSubMsg2> is deprecated: use test_roslib_comm-msg:SameSubMsg2 instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <SameSubMsg2>))
...
(cl:defmethod b-val ((m <SameSubMsg2>))
...
(cl:defmethod c-val ((m <SameSubMsg2>))
...
(cl:defmethod d-val ((m <SameSubMsg2>))
...
(cl:defmethod e-val ((m <SameSubMsg2>))
  ...
  (e m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SameSubMsg2>) ostream)
  "Serializes a message object of type '<SameSubMsg2>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SameSubMsg2>) istream)
  "Deserializes a message object of type '<SameSubMsg2>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SameSubMsg2>)))
  "Returns string type for a message object of type '<SameSubMsg2>"
  "test_roslib_comm/SameSubMsg2")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SameSubMsg2)))
  "Returns string type for a message object of type 'SameSubMsg2"
  "test_roslib_comm/SameSubMsg2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SameSubMsg2>)))
  "Returns md5sum for a message object of type '<SameSubMsg2>"
  "49145a54e4be1a218629e518575a0bf3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SameSubMsg2)))
  "Returns md5sum for a message object of type 'SameSubMsg2"
  "49145a54e4be1a218629e518575a0bf3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SameSubMsg2>)))
  "Returns full string definition for message of type '<SameSubMsg2>"
  (cl:format cl:nil "int32 a~%float32 b~%string c~%uint64[10] d~%float64[] e~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SameSubMsg2)))
  "Returns full string definition for message of type 'SameSubMsg2"
  (cl:format cl:nil "int32 a~%float32 b~%string c~%uint64[10] d~%float64[] e~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SameSubMsg2>))
  (cl:+ 0
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SameSubMsg2>))
