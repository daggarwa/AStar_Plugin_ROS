...
;//! \htmlinclude SameSubMsg3.msg.html

(cl:defclass <SameSubMsg3> (roslisp-msg-protocol:ros-message)
  ((a
    :reader a
    :initarg :a
    :type cl:integer
...
(cl:defclass SameSubMsg3 (<SameSubMsg3>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SameSubMsg3>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SameSubMsg3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_roslib_comm-msg:<SameSubMsg3> is deprecated: use test_roslib_comm-msg:SameSubMsg3 instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <SameSubMsg3>))
...
(cl:defmethod b-val ((m <SameSubMsg3>))
...
(cl:defmethod c-val ((m <SameSubMsg3>))
...
(cl:defmethod d-val ((m <SameSubMsg3>))
...
(cl:defmethod e-val ((m <SameSubMsg3>))
  ...
  (e m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SameSubMsg3>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SameSubMsg3>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SameSubMsg3>)))
  "Returns string type for a message object of type '<SameSubMsg3>"
  "test_roslib_comm/SameSubMsg3")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SameSubMsg3)))
  "Returns string type for a message object of type 'SameSubMsg3"
  "test_roslib_comm/SameSubMsg3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SameSubMsg3>)))
  "Returns md5sum for a message object of type '<SameSubMsg3>"
  "49145a54e4be1a218629e518575a0bf3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SameSubMsg3)))
  "Returns md5sum for a message object of type 'SameSubMsg3"
  "49145a54e4be1a218629e518575a0bf3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SameSubMsg3>)))
  "Returns full string definition for message of type '<SameSubMsg3>"
  (cl:format cl:nil "~%# Lots of comments~%int32 a  #And more comments~%float32 b~%string c~%# And also some white space~%~%~%uint64[10] d~% float64[] e~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SameSubMsg3)))
  "Returns full string definition for message of type 'SameSubMsg3"
  (cl:format cl:nil "~%# Lots of comments~%int32 a  #And more comments~%float32 b~%string c~%# And also some white space~%~%~%uint64[10] d~% float64[] e~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SameSubMsg3>))
  (cl:+ 0
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SameSubMsg3>))
